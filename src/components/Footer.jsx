...
const Footer = () => {
  return (
    <div
      className="w-200  lg:w-1000 flex-col
    ...
    >
      <img className="h-30 w-30 object-cover" src={zuriLogo} alt="zuri-logo" />
      <p className="text-gray-500">HNG Internship 9 Frontend Task</p>
      <img className="h-30 w-30 object-cover" src={i4G} alt="ingressive-logo" />
    </div>
  );
};
